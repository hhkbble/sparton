...
| `bench_hybrid_baseline.py` | Hybrid forward / pure-GEMM / fwd+bwd `do_bench` baselines and peak-memory check on the dev shape | `env $ENV PYTHONPATH=../src python -u bench_hybrid_baseline.py` (from this directory) |
