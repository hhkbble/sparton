...
The built system — backends, platform facts, profiling methodology, contracts,
...
optimized backend checks for CUDA sm_90+ and importable
...
pay the compile/tune cost before timed repetitions. The optimized backend
